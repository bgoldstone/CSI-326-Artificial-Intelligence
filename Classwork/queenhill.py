"""
AI Classwork 2.15.22
Source
https://webstersprodigy.net/2009/10/31/8-queens-problem-hill-climbing-python/
"""
#!/usr/bin/python
...
class queens:
    ...
    def printstats(self):
        ...
        print("Success Percentage: ", float(
            self.totalsucc)/float(self.totalruns))
        print("Average number of steps: ", float(
            self.totalnumsteps)/float(self.totalruns))
...
if __name__ == "__main__":
    ...
    mboard = queens(verbocity=options.verbose, numruns=10)
    mboard.printstats()
